...
def train_model_on_all():
    ...
    raw_stats=raw_stats.drop(['season','pts','W_L','Team_Abbrev', 'Opponent_Abbrev', 'DKP_per_minute', 'FDP_per_minute', 'SDP_per_minute','Opponent_Score','Team_Score','mp','Inactives',
                                       'Opponent_Score','game_id','game_date','player_id','Unnamed: 0','Team_pace','Team_efg_pct','Team_tov_pct','player','W_L',
                                       'Team_orb_pct','Team_ft_rate','Team_off_rtg'],axis=1)
...
def predict_winner_on_all(team1,team2):
    ...
    stats=stats.drop(['season','pts','W_L','Team_Abbrev', 'Opponent_Abbrev', 'DKP_per_minute', 'FDP_per_minute', 'SDP_per_minute','Opponent_Score','Team_Score','mp','Inactives',
                                       'Opponent_Score','game_id','game_date','player_id','Unnamed: 0','Team_pace','Team_efg_pct','Team_tov_pct','player','W_L',
                                       'Team_orb_pct','Team_ft_rate','Team_off_rtg'],axis=1)
